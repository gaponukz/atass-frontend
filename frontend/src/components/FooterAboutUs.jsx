    ...
    <div>
     ...
     <div className="cloud-box">
            ...
            <div className="row" style={{ paddingBottom: " 50px",}} id="card">
               <div className="col" >
                  <div className="card next_card" onClick={()=>{navigate("/route?move_from_city=Київ&move_to_city=Варшава&date=*")}}>
               ...
               <div className="col">
                  <div className="card next_card" onClick={()=>{navigate("/route?move_from_city=Бориспіль&move_to_city=Лодзь&date=*")}}>
                     <div className="card-body route_card_body">
                        <div >
                           Бориспіль {'  '}
                           <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="kirk-icon sc-ktwOSD kPQuM sc-dGAOeH GAPhQ" width="24" height="24" aria-hidden="true">
               ...
               <div className="col">
                  <div className="card next_card" onClick={()=>{navigate("/route?move_from_city=Київ&move_to_city=Познань&date=*")}}>
                     <div className="card-body route_card_body">
                        <div >
                           Київ {'  '}
                           <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="kirk-icon sc-ktwOSD kPQuM sc-dGAOeH GAPhQ" width="24" height="24" aria-hidden="true">
